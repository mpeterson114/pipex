...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/04 12:50:10 by mpeterso          #+#    #+#             */
/*   Updated: 2023/08/04 13:01:25 by mpeterso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*way to simplify dup2 process for child fxn, first repetition redirects to 
stdin & second rep redirects to stdout*/
...
void	child(t_ppxbonus pipex, char **argv, char **envp)
{
	...
	else if (!pipex.pid)
	{
		if (pipex.index == 0)
			...
			sub_dup2(pipex.end[2 * pipex.index - 2],
